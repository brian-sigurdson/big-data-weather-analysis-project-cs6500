...
group by usaf--, lon, lat--, theYear, theMonth
order by usaf--, lon, lat--, theYear, theMonth
)
TO 
'E:/bks006_shared/School/cs6500/Project/Data/2_postgres_queries/csv/usaf_avg_temp.csv'
